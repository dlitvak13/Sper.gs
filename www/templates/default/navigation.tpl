...
-->
			...
			<a href="http://dev.fetchrewards.com/docs/projects/api/pretty_docs/">API Documentation</a> | 
			<a href="http://192.168.1.219/api/index.php/site/timelog?secret=employees">Time Reporting</a> | 
			<a href="http://192.168.1.25/~chris/radar/index.php">Ping Pong Tracker</a> | 
			<a href="http://mantis.fetchrewards.com">Mantis BT</a> | 
			<a href="https://www.dropbox.com/sh/h0cdc85qumyea9w/SwYZG4FXho">UI Dropbox</a>
